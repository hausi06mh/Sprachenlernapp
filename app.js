'use strict';
const D=window.LUMI_DATA; const LUMI_IMG='assets/lumi-lynx.png?v=11'; const $=s=>document.querySelector(s), $$=s=>[...document.querySelectorAll(s)];
